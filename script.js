...
const faqData = [
    ...
    ["Why not open source?", "Open source would mean devs and staff could see how the code works, allowing them to potentially make patches and bypasses. Overall, keeping it closed source helps make the mod's features last longer. This also explains why it only works in mlum"],
    ];
